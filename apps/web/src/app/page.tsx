  ...
  return (
    <main className="matapan-shell matapan-section">
      <div className="flex flex-col gap-4 border-b border-(--line) pb-6">
        <p className="text-xs tracking-[0.22em] text-(--ink-2) uppercase">
          Matapan / UI Seed
        </p>
      ...
      <section className="matapan-grid mt-6 sm:grid-cols-2">
        <Link
          href="/dashboard"
          className="rounded-xl border border-(--line) bg-(--surface) p-5 transition hover:-translate-y-0.5 hover:shadow-md"
        >
          <p className="text-xs tracking-[0.16em] text-(--ink-2) uppercase">
            Read / Insight
          </p>
