    ...
    <main className="matapan-shell matapan-section">
      ...
      <section className="matapan-grid mt-6 md:grid-cols-3">
        <article className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          <p className="text-xs text-[var(--ink-2)] uppercase tracking-[0.14em]">
            Current net worth
          </p>
          ...
          <p className="mt-1 text-xs text-[var(--ink-2)]">as of {latestPoint?.date}</p>
        </article>
        ...
        <article className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          ...
          <p className="mt-1 text-xs text-[var(--ink-2)]">multi-institution sample data</p>
        </article>
        ...
        <article className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          ...
          <p className="mt-1 text-xs text-[var(--ink-2)]">status: {runs[0]?.status}</p>
        </article>
      </section>
      ...
      <section className="matapan-grid mt-6 md:grid-cols-2">
        ...
        <article className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            {runs.map((run) => (
              <li key={run.runId} className="rounded-lg border border-[var(--line)] p-3">
