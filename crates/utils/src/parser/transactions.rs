...
pub fn build_transaction(input: &TransactionInput) -> Value {
    ...
    obj.insert(
        ...
        Value::String(input.from_account_id.clone()),
    );
    obj.insert(
        "to_account_id".to_string(),
        Value::String(input.to_account_id.clone()),
    );
    obj.insert(
        "type".to_string(),
    ...
    obj.insert(
        ...
        Value::String(input.description_en.clone().unwrap_or_default()),
    );
    obj.insert("txn_id".to_string(), Value::String(input.txn_id.clone()));
    Value::Object(obj)
}
